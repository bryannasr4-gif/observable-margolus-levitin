...
\noindent The mechanism behind that empty corner is transparent, and it is the heart of the no-go. The mean energy
...
\medskip\noindent\emph{Use of AI tools.} Large language models (Anthropic Claude, Opus~4.x and Opus~5 model
series, accessed through the Claude Code command-line interface during 2026) were used substantively in
preparing this manuscript: extensively for copy-editing and rewriting of the prose, and for writing and
refactoring portions of the numerical verification and figure-generation scripts in the accompanying
repository. All output was directed by the author through iterative prompting against a fixed statement of
the results, and was verified by the author: every numerical claim in the text was checked against the
committed scripts, and every reference was checked against its published record. The theorems, their proofs,
and the closed-form constants are the author's own work and were not generated by an AI tool. The author
